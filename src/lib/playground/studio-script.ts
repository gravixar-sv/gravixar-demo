...
export const STUDIO_AGENTS: StudioAgent[] = [
  ...
  },
  {
    key: "river",
    name: "RIVER",
    role: "intake & candidate screener",
    color: "#FF2D95",
    blurb: "Screens inbound, applicants, and feedback, then assesses each against the brief, with the reasoning surfaced for a human to override.",
    feedAction: "assessed a candidate",
    feedDetail: "Senior PM application → STRONG (0.88)",
    outputTitle: "Assessment · human can override",
    outputLines: [
      "Applicant: Senior Project Manager · 6 yrs agency",
